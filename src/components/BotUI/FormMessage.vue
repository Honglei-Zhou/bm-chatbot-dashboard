<template>
  <div class="sc-message--form" :style="messageColors">
    ...
    <div v-if="data.subtitle" class="sc-message--form-text" :style="messageColors">{{ data.subtitle }}</div>
    ...
    <div v-if="data.text" class="sc-message--form-text" :style="messageColors">{{ data.text }}<p v-if="data.meta" class="sc-message--meta" :style="messageColors">{{ data.meta }}</p></div>
    <div v-if="data.buttons && data.buttons.length > 0">
      <button v-for="(formButton, idx) in data.buttons" :key="idx" :disabled="isSubmitted" :style="messageColors" @click="sendItem">{{ formButton.title }}</button>
    </div>
